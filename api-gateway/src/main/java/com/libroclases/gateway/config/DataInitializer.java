...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedUsers() {
        Map<String, Long> demoEntityIds = new LinkedHashMap<>();
        demoEntityIds.put("ADMIN", null);
        demoEntityIds.put("DOCENTE", 1L);
        demoEntityIds.put("APODERADO", 1L);
        demoEntityIds.put("ESTUDIANTE", 1L);
        ...
        demoUsers.forEach((email, roleName) -> {
            ...
            User user = User.builder()
                    ...
                    .nombre(nombre)
                    .entityId(demoEntityIds.get(roleName))
